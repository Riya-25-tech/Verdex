// Verdex network + contract configuration (Stellar testnet).

export const NETWORK_PASSPHRASE = "Test SDF Network ; September 2015";
export const RPC_URL = "https://soroban-testnet.stellar.org";

export const CONTRACTS = {
  pool: "CBY26XCUGLLR7A6EY6KJMJ2RKGACRM5AWKHEYA45HZZHZWHJPY4YGBVD",
  collateralManager: "CB7KH572Y57NWW3KAKIIAQEUI26NLS4LXVLY22634GA64OQWC2GC3XZQ",
