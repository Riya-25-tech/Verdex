    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
        ...
        <div className="flex gap-2.5">
          ...
          <Link
            href="/app/borrow"
            className="inline-flex items-center gap-1.5 rounded-xl border bg-white px-4 py-2.5 text-sm font-semibold text-[var(--text)] shadow-card transition-colors hover:bg-[var(--card-hover)]"
          >
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <StatCard icon={Users} label="Total Suppliers" value={displaySuppliers(counts, pool)} sub="Unique · on-chain" index={6} />
        <StatCard icon={Users} label="Total Borrowers" value={displayBorrowers(counts, pool)} sub="Unique · on-chain" index={7} />
      </div>
