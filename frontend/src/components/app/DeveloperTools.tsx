...
function ToolButton({
  ...
  return (
    <button
      ...
      className="inline-flex items-center justify-center gap-2 rounded-xl border bg-white px-3 py-2.5 text-sm font-medium shadow-card transition-colors hover:bg-[var(--card-hover)] disabled:opacity-50"
    >
      {loading ? (
