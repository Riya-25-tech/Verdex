      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-6 px-5 pb-12 pt-14 sm:px-8 lg:grid-cols-[1.05fr_1fr] lg:gap-4 lg:pt-20">
        ...
        <div className="text-center lg:text-left">
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            <span className="inline-flex items-center gap-2 rounded-full border bg-white/70 px-3.5 py-1.5 text-xs font-medium text-[var(--text-dim)] shadow-card backdrop-blur">
          ...
          >
            ...
            <a
              href="#features"
              className="inline-flex items-center justify-center gap-2 rounded-xl border bg-white/80 px-6 py-3.5 text-sm font-semibold text-[var(--text)] shadow-card backdrop-blur transition-colors hover:bg-[var(--card-hover)]"
            >
              Explore features
            </a>
          </motion.div>
