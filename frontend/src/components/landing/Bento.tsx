  ...
  return (
    <section id="features" className="mx-auto max-w-7xl px-5 py-20 sm:px-8">
      <div className="mx-auto max-w-2xl text-center">
        <span className="text-sm font-semibold uppercase tracking-wide text-[var(--accent)]">Why Verdex</span>
      ...
      <div className="mt-12 grid auto-rows-[1fr] gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Cell index={3} icon={KeyRound} title="Non-custodial" body="You sign every action. Verdex never holds your keys or takes custody of your funds." />
