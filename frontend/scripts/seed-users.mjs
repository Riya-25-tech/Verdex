/**
 * Verdex testnet user seeding / interaction driver.
 *
 ...
 * against the deployed Verdex contracts. Every transaction it records is a
...
const POOL = "CBY26XCUGLLR7A6EY6KJMJ2RKGACRM5AWKHEYA45HZZHZWHJPY4YGBVD";
const COLLATERAL_MANAGER = "CB7KH572Y57NWW3KAKIIAQEUI26NLS4LXVLY22634GA64OQWC2GC3XZQ";
...
const OUT = process.env.VERDEX_SEED_OUT ?? "./verdex-users.json";
